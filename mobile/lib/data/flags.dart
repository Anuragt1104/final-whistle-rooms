...
const Map<String, String> _iso = {
  ...
  'portugal': 'pt', 'netherlands': 'nl', 'holland': 'nl', 'belgium': 'be', 'croatia': 'hr',
  'uruguay': 'uy', 'mexico': 'mx', 'usa': 'us', 'united states': 'us', 'japan': 'jp',
  'morocco': 'ma', 'senegal': 'sn', 'denmark': 'dk', 'switzerland': 'ch', 'serbia': 'rs',
  'poland': 'pl', 'south korea': 'kr', 'korea republic': 'kr', 'korea': 'kr',
  'north korea': 'kp', 'canada': 'ca', 'colombia': 'co', 'nigeria': 'ng', 'ecuador': 'ec',
  'ghana': 'gh', 'cameroon': 'cm', 'australia': 'au', 'iran': 'ir', 'ir iran': 'ir',
  'egypt': 'eg', 'cape verde': 'cv', 'cabo verde': 'cv', 'saudi arabia': 'sa', 'saudi': 'sa',
  'new zealand': 'nz', 'jordan': 'jo', 'algeria': 'dz', 'south africa': 'za',
  'paraguay': 'py', 'uzbekistan': 'uz', 'italy': 'it', 'sweden': 'se', 'norway': 'no',
  'austria': 'at', 'ukraine': 'ua', 'tunisia': 'tn', 'ivory coast': 'ci', "cote d'ivoire": 'ci',
  'côte d’ivoire': 'ci', 'mali': 'ml', 'qatar': 'qa', 'iraq': 'iq',
  'united arab emirates': 'ae', 'uae': 'ae', 'peru': 'pe', 'chile': 'cl', 'venezuela': 've',
  'bolivia': 'bo', 'costa rica': 'cr', 'panama': 'pa', 'honduras': 'hn', 'jamaica': 'jm',
  'turkey': 'tr', 'türkiye': 'tr', 'greece': 'gr', 'czech republic': 'cz', 'czechia': 'cz',
  'romania': 'ro', 'hungary': 'hu', 'russia': 'ru', 'china': 'cn', 'china pr': 'cn',
  'india': 'in', 'indonesia': 'id', 'thailand': 'th', 'vietnam': 'vn', 'oman': 'om',
  'kuwait': 'kw', 'bahrain': 'bh', 'congo': 'cg', 'angola': 'ao',
  'zambia': 'zm', 'kenya': 'ke', 'uganda': 'ug', 'tanzania': 'tz', 'burkina faso': 'bf',
  'guinea': 'gn', 'gabon': 'ga', 'benin': 'bj', 'togo': 'tg', 'mauritania': 'mr',
  'sudan': 'sd', 'libya': 'ly', 'slovenia': 'si', 'slovakia': 'sk', 'albania': 'al',
  'north macedonia': 'mk', 'bosnia and herzegovina': 'ba', 'bosnia & herzegovina': 'ba',
  'bosnia': 'ba', 'dr congo': 'cd', 'congo dr': 'cd', 'congo-brazzaville': 'cg',
  'montenegro': 'me', 'finland': 'fi', 'iceland': 'is', 'ireland': 'ie',
  'israel': 'il', 'lebanon': 'lb', 'syria': 'sy', 'palestine': 'ps', 'kosovo': 'xk',
...
class CircleFlag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final border = ring
        ? Border.all(color: Colors.white.withValues(alpha: 0.85), width: size > 30 ? 2 : 1.4)
        : null;
...
class _ColorBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: size,
      height: size,
      decoration: BoxDecoration(color: teamColor(team.code), shape: BoxShape.circle, border: border),
      alignment: Alignment.center,
      child: Text(
        team.code,
        style: TextStyle(
            fontFamily: kDisplay, color: Colors.white, fontSize: size * 0.32, letterSpacing: 0.3),
      ),
    );
  }
}
