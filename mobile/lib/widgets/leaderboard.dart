...
class Leaderboard extends StatelessWidget {
  ...
  String _sideCode(MemberView m) => m.side == 'home'
                ...
                children: [
                  SizedBox(
                    ...
                    child: Text(
                      ...
                      style: display(
                        16,
                        color: i == 0 ? AppColors.orange : AppColors.mut,
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            if (_sideCode(m).isNotEmpty) ...[
                              const SizedBox(width: 5),
                              _tag(_sideCode(m), AppColors.ink),
                            ],
                            if (m.isHost) ...[
                              const SizedBox(width: 4),
                              _tag('HOST', AppColors.orange),
                            ],
                            if (isMe) ...[
                              const SizedBox(width: 4),
                              _tag('YOU', AppColors.orange),
                            ],
                            if (isMe && meIsPro) ...[
                              const SizedBox(width: 4),
                              _tag('★ PRO', AppColors.gold),
                            ],
                          ],
                        ),
  ...
  Widget _tag(String text, Color color) => Container(
    ...
    child: Text(
      text,
      style: label(color: color, size: 8, weight: FontWeight.w800),
    ),
  );
}
