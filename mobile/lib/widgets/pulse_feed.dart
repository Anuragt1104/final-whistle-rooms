...
class _PulseEntryState extends State<_PulseEntry>
  ...
  Team _sideTeam(PulseCard c) =>
      c.accent == 'away' ? widget.fixture.away : widget.fixture.home;
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        'GOAL',
                        style: display(19, color: AppColors.orangeBright),
                      ),
