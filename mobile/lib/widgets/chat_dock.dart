  ...
  Widget build(BuildContext context) {
    if (chat.isEmpty) {
      return Container(
        ...
        decoration: cardBox(),
        child: Text(
          'Say something 👋 — the terrace reacts together as the match unfolds.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontFamily: kBody,
                      fontSize: m.kind == 'reaction' ? 22 : 14,
                      color: AppColors.ink,
                      height: 1.3,
                    ),
                  ),
              ...
              if (extra > 0) ...[
                ...
                Pressable(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      '+$extra',
                      style: label(color: AppColors.mut, size: 11),
                    ),
                  ),
                ),
              ],
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  style: body(size: 14),
                  decoration: fwrInput(
                    widget.disabled ? 'Join to chat' : 'Shout it out…',
                  ),
                  onTap: widget.onTap,
                  onSubmitted: (_) => _send(),
                ),
