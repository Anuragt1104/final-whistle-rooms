    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          _perk('💎', 'Pro reaction pack', '10 exclusive reactions — 🐐 👑 🥶 💯 and more — in every room you host'),
          _perk('🛡️', 'Supporter badge', 'Stand out on leaderboards and in the terrace chat'),
