...
TeamSquad _generatedSquad(Team t) {
  ...
  for (var i = 0; i < positions.length; i++) {
    ...
    do {
      name =
          '${_fallbackFirst[rng.nextInt(_fallbackFirst.length)]} ${_fallbackLast[rng.nextInt(_fallbackLast.length)]}';
