    ...
    return Scaffold(
      ...
      body: _err != null
          ...
          : ListView(
              ...
              children: [
                Text(
                  'A gaming platform where football is the content — every layer earns.',
                ...
                if (recent.isEmpty)
                  Text(
                    'Buy a pack, trade a card or mint on Solana — events land here in real time.',
